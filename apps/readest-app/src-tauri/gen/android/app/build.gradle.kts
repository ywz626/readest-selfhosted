...
android {
    compileSdk = 36
    namespace = "com.ywz626.readest.sh"
    defaultConfig {
        manifestPlaceholders["usesCleartextTraffic"] = "false"
        applicationId = "com.ywz626.readest.sh"
        minSdk = 26
        targetSdk = 36
        versionCode = tauriProperties.getProperty("tauri.android.versionCode", "1").toInt()
        versionName = tauriProperties.getProperty("tauri.android.versionName", "1.0")
        // tauri-plugin-native-bridge 定义 store 维度（foss/googleplay），
        // 自托管版不依赖 Google Play 计费，固定使用 foss 变体
